			...
			<div className="container">
				<div className="row">
					<div className="section-header text-center">
						...
						<p className="lead">We have a variety of couses catering to everybody's interests.</p>
					</div>
				</div>
					...
					<div className="row">
						<div className="col-md-3 col-sm-6 col-xs-6">
							<div className="course">
								...
								<a className="course-title" href="#">Beginner to Guitar</a>
						...
						<div className="col-md-3 col-sm-6 col-xs-6">
							<div className="course">
								...
								<a className="course-title" href="#">Introduction to Karate </a>
								<div className="course-details">
						...
						<div className="col-md-3 col-sm-6 col-xs-6">
							<div className="course">
								...
								<a className="course-title" href="#">The Ultimate Calligraphy Course | From Beginner To Advanced</a>
								<div className="course-details">
						...
						<div className="col-md-3 col-sm-6 col-xs-6">
							<div className="course">
								...
								<a className="course-title" href="#">The Complete Western dance Course</a>
								<div className="course-details">
