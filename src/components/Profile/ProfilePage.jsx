...
import { Box, Paper, TableBody, TableCell, TableRow, Button } from "@material-ui/core";
...
const ProfilePage = () => {
    ...
    return (
        <div className="profile-container">
            ...
            <Button variant="contained" color="primary" style={{ marginTop: 20 }}>Change Password</Button>
        </div>
    );
};
